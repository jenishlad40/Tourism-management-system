...
<div><span style="margin-left:30PX; margin-bottom:20px"><form action="login.php?package_code=<?php echo $row['package_code'];  ?>" method="post" style="margin-left:30px"><input type="submit" value="Book" ><input type="button" value="Back" name="Back"></form></span></div>
<br>
</fieldset>
</DIV>
