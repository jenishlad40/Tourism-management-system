...
$create1 = mysql_query("CREATE TABLE IF NOT EXISTS info(id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), ip_address VARCHAR(30), user_agent VARCHAR(50), datetime VARCHAR(25))");
echo $create1;
if (!$create1) 
{
...
$create2 = mysql_query("CREATE TABLE IF NOT EXISTS hits(page char(100),PRIMARY KEY(page),count int(15))");
echo $create2;
if (!$create2) 
{
